...
caminatasD2(){
	...
	*/
	...
	//Simulaciones: Total de archivos a crear
...
void calcula_distancia(Float_t m_X[][S+2], Float_t m_Y[][S+2], Int_t simulaciones, Int_t caminatas){
	Float_t X = 0;
	Float_t Y = 0;
	Float_t distancia = 0;
...
void crear_archivo(Float_t m_X[][S+2], Float_t m_Y[][S+2], Int_t simulaciones, Int_t caminatas, string archivo){
